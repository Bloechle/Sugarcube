 ...
 */
package sugarcube.common.data.json.parser;
    ...
    try
    {
      do
      {
        ...
        case S_IN_PAIR_VALUE:
          /*
           * S_IN_PAIR_VALUE is just a marker to indicate the end of an object
           * entry, it doesn't proccess any token, therefore delay consuming
           * token until next round.
           */
          statusStack.removeFirst();
          status = peekStatus(statusStack);
          if (!contentHandler.endObjectEntry())
