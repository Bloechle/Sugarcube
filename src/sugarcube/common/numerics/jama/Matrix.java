package sugarcube.common.numerics.jama;
...
public class Matrix implements Cloneable, java.io.Serializable
{
   ...
   * 
   * @param r
   *          int[] Array of row indices.
   * @param j0
   *          int Initial column index
   * @param j1
   *          int Final column index
  ...
  public String toString()
  {
    ...
    {
      sg.append(Arrays.toString(A[row]));
    }
    return sg.toString();
  }
  ...
  public static void Cofactor(double mat[][], double cof[][], int p, int q)
  {
    int i = 0, j = 0;
  ...
  public static double Determinant(double[][] m)
  {
    ...
    {
      Cofactor(m, cof, 0, col);
      det += sign * m[0][col] * Determinant(cof);
      sign = -sign;
    }
    return det;
  }
  ...
  public static void main(String[] args)
  {
    ...
    System.out.print("Determinant " + "of the matrix is : " + Determinant(mat));
  }
}
