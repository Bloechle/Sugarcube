 ...
 *
 * Objects implementing this abstract class can be passed to the protect method
 * of PDDocument to protect a document.
 *
...
public abstract class ProtectionPolicy
{
   ...
   * document data. The default value is 40 bits, which provides a low security
   * level but is compatible with old versions of Acrobat Reader.
   *
   * @param l
  ...
  /**
   * Get the length of the secrete key that will be used to encrypt document
   * data.
   *
