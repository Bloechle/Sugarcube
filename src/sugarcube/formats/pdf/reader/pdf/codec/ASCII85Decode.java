...
public class ASCII85Decode
{
   ...
   *
   * @param baos the ByteArrayOutputStream to write output to, set to the correct position
  ...
  /**
   * decode an array of bytes in ASCII85 format. <p> In ASCII85 format, every 5 characters represents 4 decoded bytes in base 85. The entire stream can contain
   * whitespace, and ends in the characters '~&gt;'.
   *
  ...
  {
    return new ASCII85Decode(ByteBuffer.wrap(stream)).decode();
  }
}
