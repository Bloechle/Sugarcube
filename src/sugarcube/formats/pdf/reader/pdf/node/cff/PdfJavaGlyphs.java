...
{
  /**
   * shapes we have already drawn to speed up plotting, or
  ...
  /**
   * current font to plot, or
   * <code>null</code> if not used yet
   */
  ...
  /**
   * Returns the specified shape from the cache, or
   * <code>null</code> if the shape is not in the cache.
   */
  ...
  public int readEmbeddedFont(boolean TTstreamisCID, byte[] fontDataAsArray)
  {
    return 0;
  }
