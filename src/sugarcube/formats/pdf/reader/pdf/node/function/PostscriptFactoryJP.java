...
public class PostscriptFactoryJP
{
  static final int[] scale =
  {
    1, 26 * 26, 26 * 26 * 26, 26 * 26 * 26 * 26
  }; //alphabet so base 26 makes it unique
  ...
  public PostscriptFactoryJP(byte[] stream)
  {
  ...
  protected int execute(int id)
  {
    ...
    switch (id)
    {
      ...
      case PostscriptFactoryJP.PS_abs:
      ...
      case PostscriptFactoryJP.PS_add:
      ...
      case PostscriptFactoryJP.PS_and:
      ...
      case PostscriptFactoryJP.PS_atan:

        calculateAtan();

        break;

      case PostscriptFactoryJP.PS_bits:
      ...
      case PostscriptFactoryJP.PS_ceil:
      ...
      case PostscriptFactoryJP.PS_copy:
        /**
         * In PS the function is designed to work with any object or type. Due to smaller amount of types and procedures implemented by adobe, we shall only
         * implement one case (when int is a param).
         */
        firstInt = popInt();
        fType = currentType;
      ...
      case PostscriptFactoryJP.PS_cos:
      ...
      case PostscriptFactoryJP.PS_cvi:
        // convert to integer
      ...
      case PostscriptFactoryJP.PS_cvr:
      ...
      case PostscriptFactoryJP.PS_div:
      ...
      case PostscriptFactoryJP.PS_dup:

        calculateDup();

        break;

      case PostscriptFactoryJP.PS_eq:
      ...
      case PostscriptFactoryJP.PS_exch:
      ...
      case PostscriptFactoryJP.PS_exp:
      ...
      case PostscriptFactoryJP.PS_fals:
      ...
      case PostscriptFactoryJP.PS_floo:
      ...
      case PostscriptFactoryJP.PS_ge:
      ...
      case PostscriptFactoryJP.PS_gt:
      ...
      case PostscriptFactoryJP.PS_idiv:
      ...
      case PostscriptFactoryJP.PS_if:

        /**
         * No examples found to properly test this method. According to doc first would recieve a instruction set, which execution depends on second being
         * true(exec) or false(do not exec).
         */
        if (!cont)
        {
      ...
      case PostscriptFactoryJP.PS_inde:

        calculateIndex();

        break;

      case PostscriptFactoryJP.PS_le:
      ...
      case PostscriptFactoryJP.PS_lt:
      ...
      case PostscriptFactoryJP.PS_ln:
      ...
      case PostscriptFactoryJP.PS_log:
      ...
      case PostscriptFactoryJP.PS_mod:
      ...
      case PostscriptFactoryJP.PS_mul:
        ...
        /**
         * If the result would happend to be outside of integer range the PS_type should be set to real, for the time being I am leaving it as integer though as
         * the other situation is quite unliekly to happend.
         */
        push(first * second, PS_INTEGER);

        break;

      case PostscriptFactoryJP.PS_ne:
      ...
      case PostscriptFactoryJP.PS_neg:
      ...
      case PostscriptFactoryJP.PS_not:
      ...
      case PostscriptFactoryJP.PS_or:
      ...
      case PostscriptFactoryJP.PS_pop:
      ...
      case PostscriptFactoryJP.PS_roll:

        calculateRoll();

        break;

      case PostscriptFactoryJP.PS_roun:
      ...
      case PostscriptFactoryJP.PS_sin:

        // calc sin of a given angle
        first = pop();

        push(Math.sin(first / PostscriptFactoryJP.radiansToDegrees), PS_REAL);

        break;

      case PostscriptFactoryJP.PS_sqrt:
      ...
      case PostscriptFactoryJP.PS_sub:
      ...
      case PostscriptFactoryJP.PS_trun:
      ...
      case PostscriptFactoryJP.PS_true:
      ...
      case PostscriptFactoryJP.PS_xor:
  ...
  public double[] executePostscript()
  {
    ...
    while (ptr < streamLength)
    {
      ...
      if (nextVal != null)
         ...
         */
        if (nextVal.length == 1 && (nextVal[0] == START_BRACE || nextVal[0] == END_BRACE))
        { //recursion
