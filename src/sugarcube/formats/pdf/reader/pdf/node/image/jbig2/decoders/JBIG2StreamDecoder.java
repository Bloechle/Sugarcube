...
import sugarcube.formats.pdf.reader.pdf.node.image.jbig2.io.StreamReader;
import sugarcube.formats.pdf.reader.pdf.node.image.jbig2.segment.Segment;
import sugarcube.formats.pdf.reader.pdf.node.image.jbig2.segment.SegmentHeader;
import sugarcube.formats.pdf.reader.pdf.node.image.jbig2.segment.extensions.ExtensionSegment;
import sugarcube.formats.pdf.reader.pdf.node.image.jbig2.segment.pageinformation.PageInformationSegment;
import sugarcube.formats.pdf.reader.pdf.node.image.jbig2.segment.pattern.PatternDictionarySegment;
import sugarcube.formats.pdf.reader.pdf.node.image.jbig2.segment.region.generic.GenericRegionSegment;
import sugarcube.formats.pdf.reader.pdf.node.image.jbig2.segment.region.halftone.HalftoneRegionSegment;
import sugarcube.formats.pdf.reader.pdf.node.image.jbig2.segment.region.refinement.RefinementRegionSegment;
import sugarcube.formats.pdf.reader.pdf.node.image.jbig2.segment.region.text.TextRegionSegment;
import sugarcube.formats.pdf.reader.pdf.node.image.jbig2.segment.stripes.EndOfStripeSegment;
import sugarcube.formats.pdf.reader.pdf.node.image.jbig2.segment.symboldictionary.SymbolDictionarySegment;
