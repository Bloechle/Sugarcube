...
public class HeadTable extends TTFTable
{
  ...
  {
    if (data.remaining() != 54 && data.remaining() != 56)
      Log.warn(this, ".setData - bad head table size: " + data.remaining() + " (should be 54)"); //throw new IllegalArgumentException("Bad Head table size");
