...
public class Glyf
{
  ...
  /**
   * Get the data in this glyf as a byte buffer. Return the basic glyf data only, since there is no specific data. This method returns the data un-flipped, so
   * subclasses can simply append to the allocated buffer.
   */
