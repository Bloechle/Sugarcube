...
public abstract class CMap
{
   ...
   *
   * <p>The Macintosh standard character to glyph mapping is supported by format 0.</p>
   *
   * <p>Format 2 supports a mixed 8/16 bit mapping useful for Japanese, Chinese and Korean. </p>
   *
   * <p>Format 4 is used for 16 bit mappings.</p>
   *
   * <p>Format 6 is used for dense 16 bit mappings.</p>
   *
   * <p>Formats 8, 10, and 12 (properly 8.0, 10.0, and 12.0) are used for mixed 16/32-bit and pure 32-bit mappings.<br> This supports text encoded with
   * surrogates in Unicode 2.0 and later.</p>
   *
   * <p>Reference:<br> http://developer.apple.com/textfonts/TTRefMan/RM06/Chap6cmap.html </p>
   */
