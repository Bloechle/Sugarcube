...
public class TTFTable
{
   ...
   *
   * This method is protected. Use the
   * <code>getTable()</code> methods to get new instances.
   *
   * @param tag the tag for this table
   */
  protected TTFTable(int tag)
  {
    this.tag = tag;
  }
   ...
   * @param tagString the tag for this table, as a 4 character string (e.g. head or cmap)
   */
  public static TTFTable createTable(TTF ttf,
                                     String tagString)
  {
   ...
   */
  public static TTFTable createTable(TTF ttf, String tagString, ByteBuffer data)
  {
    TTFTable outTable = null;
