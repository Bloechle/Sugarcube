 ...
 * Class: PktDecoder
 *
 * Description: Reads packets heads and keeps location of code-blocks' codewords
 *
 *
 *
 * COPYRIGHT:
 *
 * This software module was originally developed by Raphael Grosbois and Diego Santa Cruz (Swiss Federal Institute of Technology-EPFL); Joel Askelef (Ericsson
 * Radio Systems AB); and Bertrand Berthelot, David Bouchard, Felix Henry, Gerard Mozelle and Patrice Onno (Canon Research Centre France S.A) in the course of
 * development of the JPEG2000 standard as specified by ISO/IEC 15444 (JPEG 2000 Standard). This software module is an implementation of a part of the JPEG 2000
 * Standard. Swiss Federal Institute of Technology-EPFL, Ericsson Radio Systems AB and Canon Research Centre France S.A (collectively JJ2000 Partners) agree not
 * to assert against ISO/IEC and users of the JPEG 2000 Standard (Users) any of their rights under the copyright, not including other intellectual property
 * rights, for this software module with respect to the usage by ISO/IEC and Users of this software module or modifications thereof for use in hardware or
 * software products claiming conformance to the JPEG 2000 Standard. Those intending to use this software module in hardware or software products are advised
 * that their use may infringe existing patents. The original developers of this software module, JJ2000 Partners and ISO/IEC assume no liability for use of
 * this software module or modifications thereof. No license or right to this software module is granted for non JPEG 2000 Standard conforming products. JJ2000
 * Partners have full right to use this software module for his/her own purpose, assign or donate this software module to any third party and to inhibit third
 * parties from using this software module for non JPEG 2000 Standard conforming products. This copyright notice must be included in all copies or derivative
...
public class PktDecoder implements StdEntropyCoderOptions
{
   ...
   *
   * <ul> <li> 1st dim: component index.</li> <li> 2nd dim: resolution level index.</li> </ul>
     *
   */
   ...
   *
   * <ul> <li> 1st dim: component index.</li> <li> 2nd dim: resolution level index.</li> <li> 3rd dim: precinct index.</li> </ul>
     *
   */
   ...
   *
   * <ul> <li> 1st dim: component index.</li> <li> 2nd dim: resolution level index.</li> <li> 3rd dim: subband index.</li> <li> 4th/5th dim: code-block index
   * (vert. and horiz.).</li> </ul> 
     *
   */
  private int[][][][][] lblock;
  /**
   ...
   *
   * <ul> <li> 1st dim: component index.</li> <li> 2nd dim: resolution level index.</li> <li> 3rd dim: precinct index.</li> <li> 4th dim: subband index.</li>
     *
   */
  ...
  /**
   * Creates an empty PktDecoder object associated with given decoder specifications and HeaderDecoder. This object must be initialized thanks to the restart
   ...
   *
   * @param mdl The maximum number of decomposition level in each component of this tile
   *
   ...
   *
   * @param cbI CBlkInfo array of relevant component and resolution level.
   *
   * @param nb The number of bytes to read in each tile before reaching output rate (used by truncation mode)
   *
...
//                         throw new EOFException();
  ...
  /**
   * Reads specificied packet body in order to find offset of each code-block's piece of codeword. This use the list of found code-blocks in previous red packet
   * head.
   *
   * @param l layer index
   *
   ...
   * @param cbI CBlkInfo array of relevant component and resolution level.
   *
   * @param nb The remainding number of bytes to read from the bit stream in each tile before reaching the decoding rate (in truncation mode)
   *
    ...
    int[] nb) throws IOException
  {
    ...
    for (int s = mins; s < maxs; s++)
      ...
      } // Loop on code-blocks // End loop on subbands
