...
/**
 * Classe that holds information found in the marker segments of the main and tile-part headers. There is one inner-class per marker segment type found in these
 * headers.
 *
 */
  ...
  Cloneable
{
  ...
  /**
   * Reference to the COC marker segments found in main and first tile-part header. The key is either "main_c"+componentIndex or
   * "t"+tileIdx+"_c"+component_index.
   */
  public Hashtable coc = new Hashtable();
  /**
   * Reference to the RGN marker segments found in main and first tile-part header. The key is either "main_c"+componentIndex or
   * "t"+tileIdx+"_c"+component_index.
   */
  ...
  /**
   * Reference to the QCC marker segments found in main and first tile-part header. They key is either "main_c"+componentIndex or
   * "t"+tileIdx+"_c"+component_index.
   */
