...
/**
 * This exception is thrown whenever an illegal value is read from a bit stream. The cause can be either a corrupted bit stream, or a a bit stream which is
 * illegal.
 *
 */
...
{
  /**
   * Constructs a new <tt>CorruptedCodestreamException</tt> exception with no detail message.
     *
   */
  ...
  /**
   * Constructs a new <tt>CorruptedCodestreamException</tt> exception with the specified detail message.
   *
