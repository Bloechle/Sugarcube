 ...
 *
 * <P>Its purpose it is to ease the development and testing process. A class that partially implements its functionality should throw a
 * <tt>NotImplementedError</tt> when a method that has not yet been implemented is called.
 *
 * <P>This class is made a subclass of <tt>Error</tt> since it should never be caught by an application. There is no need to declare this exception in the
 * <tt>throws</tt> clause of a method.
 *
 * @see Error
 */
...
{
  /**
   * Constructs a new <tt>NotImplementedError</tt> exception with the default detail message. The message is:
   *
  ...
  /**
   * Constructs a new <tt>NotImplementedError</tt> exception with the specified detail message <tt>m</tt>.
   *
