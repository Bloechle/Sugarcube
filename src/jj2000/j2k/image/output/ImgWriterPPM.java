 ...
 *
 * <P>The size of the image that is written is the size of the source image. No component subsampling is allowed in any of the components that are written to
 * the file.
 *
 * <P>Before writing, all coefficients are inversly level-shifted and then "saturated" (they are limited * to the nominal dynamic range).<br>
 *
 * <u>Ex:</u> if the nominal range is 0-255, the following algorithm is applied:<br>
 *
...
public class ImgWriterPPM extends ImgWriter
{
   ...
   *
   * <p>The three components that will be written as R, G and B must be specified through the b1, b2 and b3 arguments.</p>
   *
   * @param out The file where to write the data
   *
   * @param imgSrc The source from where to get the image data to write.
   *
   * @param n1 The index of the first component from where to get the data, that will be written as the red channel.
   *
   * @param n2 The index of the second component from where to get the data, that will be written as the green channel.
   *
   * @param n3 The index of the third component from where to get the data, that will be written as the green channel.
   *
   * @see DataBlk
     *
   */
   ...
   * memory usage.
   *
   * <P>If the data returned from the BlkImgDataSrc source is progressive, then it is requested over and over until it is not progressive any more.
   *
   * @exception IOException If an I/O error occurs.
     *
   */
