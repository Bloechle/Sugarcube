...
{
  /**
   * Constructs a new <tt>NoNextElementException</tt> exception with no detail message.
   *
   *
   */
  ...
  /**
   * Constructs a new <tt>NoNextElementException</tt> exception with the specified detail message.
   *
