...
/**
 * This class inherits from the analysis wavelet filter definition for int data. It implements the forward wavelet transform specifically for the 5x3 filter.
...
public class AnWTFilterIntLift5x3 extends AnWTFilterInt
{
  ...
  /**
   * An implementation of the analyze_lpf() method that works on int data, for the forward 5x3 wavelet transform using the lifting scheme. See the general
  ...
  /**
   * An implementation of the analyze_hpf() method that works on int data, for the forward 5x3 wavelet transform using the lifting scheme. See the general
   ...
   *
   * <p>Currently the implementation of this method only tests if 'obj' is also of the class AnWTFilterIntLift5x3.</p>
   *
