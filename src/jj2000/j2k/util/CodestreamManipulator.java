...
public class CodestreamManipulator
{
  ...
  /**
   * This method parses the codestream for SOT, SOP and EPH markers and removes header header bits signalling SOP and EPH markers if packed packet headers are
   * used
   *
