...
/**
 * This is the base class for all modules in the colorspace and icc profiling steps of the decoding chain. It is responsible for the allocation and
 * iniitialization of all working storage. It provides several utilities which are of generic use in preparing DataBlks for use and provides default
    ...
    throws IOException, ColorSpaceException, ICCProfileException
  {
    ...
    else
    {
      ...
      if (colorspace == ColorSpace.CMYK)
        return CMYKColorSpaceMapper.createInstance(src, csMap);
