...
/**
 * This class models the ICCProfile file. This file is a binary file which is divided into two parts, an ICCProfileHeader followed by an ICCTagTable. The header
 * is a straightforward list of descriptive parameters such as profile size, version, date and various more esoteric parameters. The tag table is a structured
 * list of more complexly aggragated data describing things such as ICC curves, copyright information, descriptive text blocks, etc.
 *
 * Classes exist to model the header and tag table and their various constituent parts the developer is refered to these for further information on the
...
public abstract class ICCProfile
{
  ...
  /**
   * Create a String from a byte []. Optionally swap adjacent byte pairs. Intended to be used to create integer String representations allowing for endian
   * translations.
   *
  ...
  public static String toHexString(short i)
  {
    ...
    if (i >= 0 && i < 0x10)
      rep = "000" + Integer.toHexString((int) i);
    else if (i >= 0 && i < 0x100)
      rep = "00" + Integer.toHexString((int) i);
    else if (i >= 0 && i < 0x1000)
      rep = "0" + Integer.toHexString((int) i);
    else
      rep = "" + Integer.toHexString((int) i);
  ...
  public static String toHexString(int i)
  {
    ...
    if (i >= 0 && i < 0x10)
      rep = "0000000" + Integer.toHexString((int) i);
    else if (i >= 0 && i < 0x100)
      rep = "000000" + Integer.toHexString((int) i);
    else if (i >= 0 && i < 0x1000)
      rep = "00000" + Integer.toHexString((int) i);
    else if (i >= 0 && i < 0x10000)
      rep = "0000" + Integer.toHexString((int) i);
  ...
  /**
   * Parse this ICCProfile into a RestrictedICCProfile which is appropriate to the data in this profile. Either a MonochromeInputRestrictedProfile or
